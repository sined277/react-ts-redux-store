...
import PizzaBlockInCart from "../components/Pizza/PizzaBlockInCart"
import { useSelector } from "react-redux"
import { clearCart } from "../feautures/slices/cartSlice"
...
const Cart:React.FC = () => {
    ...
    const pizzasInCart = useSelector((state) => state.cart.pizzasInCartData)
            ...
            <div className="cart">
                <div className="cart__top">
                    <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Корзина</h2>
                    <div onClick={clearCartData} className="cart__clear">
                ...
                <div className="content__items">
                    {pizzasInCart.map((pizza) => {
                        return (
                            <PizzaBlockInCart key={pizza.id} {...pizza} />
                        )
                    })}
                </div>
