...
import { addProductInCart, removeProduct, minusPizza, CartItem } from '../../feautures/slices/cartSlice'

type PizzaBlockInCartProps = {
    id: string,
    title: string,
    imageUrl: string,
    price: number,
...
const PizzaBlockInCart: React.FC<PizzaBlockInCartProps> = ({ id, title, imageUrl, price, count }) => {
...
export default PizzaBlockInCart